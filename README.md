...
correctly. This repository includes both the final pdf file in the
`manuscript` folder, and the `source` files used to generate it.

In each case the citation below links to the journal DOI for the version
of record, but if anyone wishes to share copies of my older papers
*without* deadnaming me in the process, you can use the versions hosted
here\!
